...
export default class SignUpPanel extends Component {
    ...
    render() {
        let {username, nameErr, passw, passwErr, cfPassw, cfPasswErr} = this.state;
            ...
            <div className={S.sign_panel}>
                ...
                <form className="ui form" onSubmit={onSubmit}>
                    ...
                    <div className={`field ${passwErr ? 'error' : ''}`}>
                        <input type="text" placeholder="密码" value={passw} onChange={passwChange} ref="passwDom"/>
                        {passwErrMsg}
                    </div>
                    <div className={`field ${cfPasswErr ? 'error' : ''}`}>
                        <input type="text" placeholder="确认密码" value={cfPassw} onChange={cfPasswChange}
                               ref="cfPasswDom"/>
                        {cfPasswErrMsg}
                    </div>
                    <div className={`field`}>
